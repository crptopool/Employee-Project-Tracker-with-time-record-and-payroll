...
class ProjectController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $entities = $em->getRepository('EmployeeBundle:Project')->findLatestProjects();
    ...
    public function showIndividualProjectsAction()
    {
        ...
        $projects = $em->getRepository('EmployeeBundle:Project')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        $this->addFlash('danger', 'Please check for errors!');
    ...
    public function showAction(Request $request, $id)
    {
       ...
       // $projectTask1 = $projectTask->projecttask($entity);
        ...
        //die();
        $tasks = $em->getRepository('EmployeeBundle:Task')->getTasksForProject($entity->getId());
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        $this->addFlash('danger', 'Check for errors!');
        return $this->render('EmployeeBundle:Project:edit.html.twig', array(
            'entity'      => $entity,
            'edit_form'   => $editForm->createView(),
            'delete_form' => $deleteForm->createView(),
